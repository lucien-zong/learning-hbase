...
public class GetTimeTest {
	...
	public static void main(String[] args) throws Exception {
		...
		FilterList fl = new FilterList(expressionFilter1);

		scan.setFilter(fl);
		int count = 0;
		ResultScanner scanner = table.getScanner(scan);
		Result r = scanner.next();// keyvalues={0,c01/family:compositeLongStr/1370592062825/Put/vlen=5/ts=0,
									// 0,c01/family:long/1370592062825/Put/vlen=8/ts=0,
									// 0,c01/family:longStr1/1370592062825/Put/vlen=1/ts=0,
									// 0,c01/family:longStr2/1370592062825/Put/vlen=1/ts=0,
									// 0,c01/family:mod10Str/1370592062825/Put/vlen=1/ts=0}
		while (r != null) {
			count++;
			r = scanner.next();
		}
